...
");
        ...
        protected void AddCellText(string text, bool highlight = false, bool IsGood = false, string tooltip = null)
        {
            ...
            {
                Add("<td class='text'>");
                //Add($"<p class = 'line-clamp' data-title='{text}' data-show='0'>");
                Add($"<p class = 'line-clamp' title='{text}'>");
                ...
                Add(@"</p>");
                //Add($"<div class='adina-tooltip-outer'><div class='adina-tooltip'>'{text}'</div></div>");
                Add(@"</td>");
            }
            catch (Exception e)
            {
